...
const nextConfig: NextConfig = {
  ...
  env: {
    NEXT_PUBLIC_API_URL:
      process.env.NEXT_PUBLIC_API_URL || "hhttps://gateway.ftestqoed.com",
    NEXT_PUBLIC_WS_URL:
      process.env.NEXT_PUBLIC_WS_URL || "wss://gateway.ftestqoed.com",
    NEXT_PUBLIC_CRYPTO_SECRET:
      process.env.NEXT_PUBLIC_CRYPTO_SECRET || "secret-key",
  },
